...
int main() {
  ...
  cout << "Test 1 - Create Truck (8000 kg, 120 L, 1800 kg cargo) and travel 100 km at 90 km/h\n";
  ...
  cout << "Test 2 - Create Truck (10000 kg, 150 L, 3000 kg cargo), set fuel to 50 %, travel 200 km at 110 km/h\n";
  t2.set_fuelPercentage(50);
  t2.set_numberOfTrips(2);       // simulate prior use
  cout << "Fueyy: "  << t2.get_fuelPercentage() << "%\n";
  ...
  cout << "Test 3 - Create Truck (9000 kg, 100 L, 2600 kg cargo), set fuel = 11 %, attempt 100 km at 70 km/h (should refuse)\n";
