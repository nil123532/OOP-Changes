...
int main() {
  ...
  cout << "Test 1 - Create a Car (1500 kg, 50 L, 4 passengers) and travel 100 km at 90 km/h\n";
  ...
  cout << "Test 2 - Create a Car (1600 kg, 60 L, 5 passengers). Set fuel to 15 %, simulate prior trips, then travel 200 km at 120 km/h\n";
